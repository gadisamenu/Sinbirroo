    ...
    public class MappingProfiles:Profile
    {
        public MappingProfiles()
        {
            ...
            CreateMap<Comment, CommentDto>()
                .ForMember(p => p.DisplayName, o=> o.MapFrom(c =>c.Author.DisplayName))
                .ForMember(p => p.Username, o => o.MapFrom(c => c.Author.UserName))
                .ForMember(p => p.Image, o => o.MapFrom(c => c.Author.Photos.FirstOrDefault(x => x.IsMain).Url));
