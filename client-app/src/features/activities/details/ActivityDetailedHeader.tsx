        ...
        <Segment.Group>
            <Segment basic attached='top' style={{padding: '0'}}>
                {activity.isCancelled &&(
                    <Label style={{position:"absolute",left:-14,top:20,zIndex:1000}}  ribbon color='red' content="Cancelled"/>
                )}
            ...
            <Segment clearing attached='bottom'>
                {activity.isHost?
                    ...
                    (<Button loading={loading} disabled={activity.isCancelled} onClick={updateAttendence} color='teal'>Join Activity</Button>)
                }
            </Segment>
        </Segment.Group>
    )
